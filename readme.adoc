...
The extension works with Neo4j all 3.x versions, and the code on this branch is for *{branch}*.
...
4. You might need to add this line: +
...
NOTE: You might need to add `,graphql.*` if your config contains this line: `dbms.security.procedures.unrestricted=`
